package ies.jandula.dragonBall.exceptions;
...
public class DragonBallExceptions extends Exception
{
	 ...
	 */
	public DragonBallExceptions(int code, String message)
	{
		super(message);
	 ...
	 */
	public DragonBallExceptions(int code, String message, Throwable exception)
	{
